...
def generate_random_slices(data_dir_masks, data_dir_radargrams, 
                           profile_name, output_dir_masks, 
                           output_dir_radargrams, num_patches, 
                           patch_size, display_time=2):
    """
    ...
    try:
        ...
        image_path_radargram_csv = os.path.join(data_dir_radargrams, f"{profile_name}.csv")
...
for profile_name in profile_names:
    generate_random_slices(data_dir_masks, data_dir_radargrams, 
                           str(profile_name), output_dir_masks, 
                           output_dir_radargrams, num_patches, 
                           patch_size, display_time)
